  ...
  return (
    <>
      <div className="container">
        <Head>
          <title>ComingSoon - Ericka Negreiros</title>
          <meta
            name="description"
            content="Site oficial da empresa Ericka Negreiros Alcantara ME."
          />
          <meta property="og:title" content="ComingSoon - Ericka Negreiros" />
          <meta
        ...
        <div className="container1">
          <div className="main">
            ...
            <div className="grid">
              <img
                alt="image"
                src="/playground_assets/iphone-3-1100w.png"
                className="image"
              />
              <img
                alt="image"
                src="/playground_assets/iphone-2-1100w.png"
                className="image01"
              />
              <img
                alt="image"
                src="/playground_assets/iphone-4-1100w.png"
                className="image02"
              />
              <img
                alt="image"
                src="/playground_assets/iphone-1-1100w.png"
                className="image03"
              />
              <img
                alt="image"
