  ...
  return (
    <>
      <div className="container">
        <Head>
          <title>Profile - Ericka Negreiros</title>
          <meta
            name="description"
            content="Site oficial da empresa Ericka Negreiros Alcantara ME."
          />
          <meta property="og:title" content="Profile - Ericka Negreiros" />
          <meta
            ...
            <div className="form">
              ...
              <form className="form1">
                ...
                <input
                  ...
                  className="textinput input small"
                />
                <label className="text22 label">I&apos;m looking for</label>
                <input
                  type="text"
                  placeholder="What you love"
                  className="textinput1 input small"
                />
      ...
      <style jsx>
        {`
          ...
          .info {
            ...
            background-image: url('/playground_assets/curved5-1500w.jpg');
